/* src/config/qmc-config.h.  Generated from qmc-config.h.in by configure.  */
/* src/config/qmc-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.qmc.network"

/* Define to the full name of this package. */
#define PACKAGE_NAME "QMCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "QMCoin Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "qmc"
