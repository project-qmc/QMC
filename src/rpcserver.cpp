...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* QMC features */
        {"qmc", "masternode", &masternode, true, true, false},
        {"qmc", "listmasternodes", &listmasternodes, true, true, false},
        {"qmc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"qmc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"qmc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"qmc", "masternodedebug", &masternodedebug, true, true, false},
        {"qmc", "startmasternode", &startmasternode, true, true, false},
        {"qmc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"qmc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"qmc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"qmc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"qmc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"qmc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"qmc", "mnbudget", &mnbudget, true, true, false},
        {"qmc", "preparebudget", &preparebudget, true, true, false},
        {"qmc", "submitbudget", &submitbudget, true, true, false},
        {"qmc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"qmc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"qmc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"qmc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"qmc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"qmc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"qmc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"qmc", "checkbudgets", &checkbudgets, true, true, false},
        {"qmc", "mnsync", &mnsync, true, true, false},
        {"qmc", "spork", &spork, true, true, false},
        {"qmc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"qmc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
	...
	FILE * pFile;
    #ifdef WIN32
    char output[128]; // More than anyone should need (Bill Gates, 1981)
    wcstombs(output, GetConfigFile().c_str(), 128);
    pFile = fopen(output,"a");
    #else
	pFile = fopen(GetConfigFile().c_str(),"a");
    #endif
	fprintf(pFile,"rpcuser=qmcrpc\nrpcpassword=%s\n", EncodeBase58(&rand_pwd[0], &rand_pwd[0] + 32).c_str());
	if(pFile != NULL)
	fclose(pFile);
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use qmcd, or the magnet search tool (QMT), we must set a user/pass in:\n"
                                               "%s\n"
                                               "\nWe have set the following random password:\n"
                                               "rpcuser=qmcrpc\n"
                                               "rpcpassword=%s\n"
                                               "(you do not need to remember this password)\n"
                                               "\nYou can change this to anything you prefer at any time.\n"
                                               "If QMT does not recognize this, use the setup menu within the tool.\n\n     The wallet will now shutdown - Please start it again !\n"),
                                             GetConfigFile().string(),
                                             EncodeBase58(&rand_pwd[0], &rand_pwd[0] + 32)),
            "", CClientUIInterface::MSG_NOTICE | CClientUIInterface::SECURE);
        StartShutdown();
        return;
    }
...
{
    return "> qmc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6082/\n";
}
