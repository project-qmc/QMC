...
static const unsigned int MAX_INV_SZ = 5000000;
/** The maximum number of new addresses to accumulate before announcing. */
static const unsigned int MAX_ADDR_TO_SEND = 1000;
/** Maximum length of incoming protocol messages (no message over 1 GB is currently acceptable). */
static const unsigned int MAX_PROTOCOL_MESSAGE_LENGTH = 1024 * 1024 * 1024;
/** -listen default */
