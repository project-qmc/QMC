...
// QMC: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
	...
	if (nSporkID == SPORK_37_DI_CONTROL) r = SPORK_37_DI_CONTROL_DEFAULT;
	if (nSporkID == SPORK_38_DI_VALUE) r = SPORK_38_DI_VALUE_DEFAULT;
...
bool CSporkManager::CheckSignature(CSporkMessage& spork)
{
    ...
    string strSporkKey = "04be73745881d6babaa9f268fa0a6a01e19716a2c73b75810fa757a1732967c708a0f9dd79b78e4e20458a4328bfe525356782df9d1bed2bf87f1af76d83da4720";
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_16_ZEROCOIN_MAINTENANCE_MODE") return SPORK_16_ZEROCOIN_MAINTENANCE_MODE;
        ...
        if (strName == "SPORK_37_DI_CONTROL")  return SPORK_37_DI_CONTROL;
        if (strName == "SPORK_38_DI_VALUE")  return SPORK_38_DI_VALUE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_16_ZEROCOIN_MAINTENANCE_MODE) return "SPORK_16_ZEROCOIN_MAINTENANCE_MODE";
        ...
        if (id == SPORK_37_DI_CONTROL) return "SPORK_37_DI_CONTROL";
        if (id == SPORK_38_DI_VALUE) return "SPORK_38_DI_VALUE";
