    ...
    proposalList(0), columnResizingFixer(0)
{
    ...
    proposalWidget->setPlaceholderText(tr("Start your search here!"));
#endif
...
/*
...
#if QT_VERSION >= 0x040700
    noVotesWidget->setPlaceholderText(tr("Min 'Good' votes"));
#endif
...
#if QT_VERSION >= 0x040700
    percentageWidget->setPlaceholderText(tr("Vote percentage"));
#endif
	...
	*/
    ...
    QPushButton *voteYesButton = new QPushButton(tr("Vote Good!"), this);
...
*/
    QPushButton *voteNoButton = new QPushButton(tr("Vote Bad!"), this);
    ...
    QAction *voteYesAction = new QAction(tr("Vote GOOD!"), this);
//    QAction *voteAbstainAction = new QAction(tr("Vote abstain"), this);
    QAction *voteNoAction = new QAction(tr("Vote BOO!"), this);
    QAction *openUrlAction = new QAction(tr("Download Torrent"), this);
    QAction *openStatisticsAction = new QAction(tr("Stream this now!"), this);
...
//openStatisticsAction
    connect(openStatisticsAction, SIGNAL(triggered()), this, SLOT(openStatisticsAction()));
...
//openStatisticsAction
void ProposalList::openStatisticsAction()
{
    if(!proposalList || !proposalList->selectionModel())
        return;
    ...
    QModelIndexList selection = proposalList->selectionModel()->selectedRows(0);
    if(!selection.isEmpty())
         QDesktopServices::openUrl("https://instant.io/#" + selection.at(0).data(ProposalTableModel::ProposalUrlRole).toString());
}
