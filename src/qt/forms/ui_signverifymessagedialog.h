...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setMinimumSize(QSize(0, 30));
        addressIn_SM->setMaximumSize(QSize(16777215, 30));
        ...
        addressBookButton_SM->setMinimumSize(QSize(30, 30));
        addressBookButton_SM->setMaximumSize(QSize(30, 30));
        QIcon icon;
        ...
        pasteButton_SM->setMinimumSize(QSize(30, 30));
        pasteButton_SM->setMaximumSize(QSize(30, 30));
        QIcon icon1;
        ...
        signatureOut_SM->setMinimumSize(QSize(0, 30));
        signatureOut_SM->setMaximumSize(QSize(16777215, 30));
        QFont font;
        font.setItalic(true);
        ...
        copySignatureButton_SM->setMinimumSize(QSize(30, 30));
        copySignatureButton_SM->setMaximumSize(QSize(30, 30));
        QIcon icon2;
        ...
        signMessageButton_SM->setMinimumSize(QSize(120, 30));
        signMessageButton_SM->setMaximumSize(QSize(120, 30));
        QIcon icon3;
        ...
        clearButton_SM->setMinimumSize(QSize(120, 30));
        clearButton_SM->setMaximumSize(QSize(120, 30));
        QIcon icon4;
        ...
        addressIn_VM->setMinimumSize(QSize(0, 30));
        addressIn_VM->setMaximumSize(QSize(16777215, 30));
        ...
        addressBookButton_VM->setMinimumSize(QSize(30, 30));
        addressBookButton_VM->setMaximumSize(QSize(30, 30));
        ...
        signatureIn_VM->setMinimumSize(QSize(0, 30));
        signatureIn_VM->setMaximumSize(QSize(16777215, 30));
        ...
        verifyMessageButton_VM->setMinimumSize(QSize(120, 30));
        verifyMessageButton_VM->setMaximumSize(QSize(120, 30));
        QIcon icon5;
        ...
        clearButton_VM->setMinimumSize(QSize(120, 30));
        clearButton_VM->setMaximumSize(QSize(120, 30));
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The QMC address to sign the message with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this QMC address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The QMC address the message was signed with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_SHORTCUT
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified QMC address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
