...
public:
    ...
    void setupUi(QDialog *EditAddressDialog)
    {
        ...
        EditAddressDialog->setStyleSheet(QStringLiteral("QPushButton{width: 80px; height: 25px;}"));
        ...
        labelEdit->setMinimumSize(QSize(0, 30));
        labelEdit->setMaximumSize(QSize(16777215, 30));
        ...
        addressEdit->setMinimumSize(QSize(0, 30));
        addressEdit->setMaximumSize(QSize(16777215, 30));
    ...
    void retranslateUi(QDialog *EditAddressDialog)
    {
        ...
        labelEdit->setToolTip(QApplication::translate("EditAddressDialog", "The label associated with this address list entry", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("EditAddressDialog", "&Address", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        addressEdit->setToolTip(QApplication::translate("EditAddressDialog", "The address associated with this address list entry. This can only be modified for sending addresses.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
