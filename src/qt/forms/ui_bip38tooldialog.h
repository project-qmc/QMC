...
public:
    ...
    void setupUi(QDialog *Bip38ToolDialog)
    {
        ...
        horizontalLayout_1_ENC->addItem(horizontalSpacer);

        addressIn_ENC = new QValidatedLineEdit(tabBip38Encrypt);
        addressIn_ENC->setObjectName(QStringLiteral("addressIn_ENC"));
        addressIn_ENC->setMinimumSize(QSize(0, 30));
        addressIn_ENC->setMaximumSize(QSize(16777215, 30));
        ...
        addressBookButton_ENC->setMinimumSize(QSize(30, 30));
        addressBookButton_ENC->setMaximumSize(QSize(30, 30));
        QIcon icon;
        ...
        pasteButton_ENC->setMinimumSize(QSize(30, 30));
        pasteButton_ENC->setMaximumSize(QSize(30, 30));
        QIcon icon1;
        ...
        passphraseIn_ENC->setMinimumSize(QSize(0, 30));
        passphraseIn_ENC->setMaximumSize(QSize(16777215, 30));
        ...
        horizontalLayout_2_ENC->addItem(horizontalSpacer_3);

        encryptedKeyOut_ENC = new QLineEdit(tabBip38Encrypt);
        encryptedKeyOut_ENC->setObjectName(QStringLiteral("encryptedKeyOut_ENC"));
        encryptedKeyOut_ENC->setMinimumSize(QSize(0, 30));
        encryptedKeyOut_ENC->setMaximumSize(QSize(16777215, 30));
        QFont font;
        font.setItalic(true);
        ...
        copyKeyButton_ENC->setMinimumSize(QSize(30, 30));
        copyKeyButton_ENC->setMaximumSize(QSize(30, 30));
        QIcon icon2;
        ...
        clearButton_ENC->setMinimumSize(QSize(120, 30));
        clearButton_ENC->setMaximumSize(QSize(120, 30));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icons/remove"), QSize(), QIcon::Normal, QIcon::Off);
        clearButton_ENC->setIcon(icon3);
        ...
        encryptKeyButton_ENC->setMinimumSize(QSize(120, 30));
        encryptKeyButton_ENC->setMaximumSize(QSize(120, 30));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/icons/edit"), QSize(), QIcon::Normal, QIcon::Off);
        encryptKeyButton_ENC->setIcon(icon4);
        ...
        encryptedKeyIn_DEC->setMinimumSize(QSize(0, 30));
        encryptedKeyIn_DEC->setMaximumSize(QSize(16777215, 30));
        ...
        passphraseIn_DEC->setMinimumSize(QSize(0, 30));
        passphraseIn_DEC->setMaximumSize(QSize(16777215, 30));
        ...
        clearButton_DEC->setMinimumSize(QSize(120, 30));
        clearButton_DEC->setMaximumSize(QSize(120, 30));
        clearButton_DEC->setIcon(icon3);
        ...
        decryptKeyButton_DEC->setMinimumSize(QSize(120, 30));
        decryptKeyButton_DEC->setMaximumSize(QSize(120, 30));
        QIcon icon5;
        ...
        decryptedKeyOut_DEC->setMinimumSize(QSize(0, 30));
        decryptedKeyOut_DEC->setMaximumSize(QSize(16777215, 30));
        ...
        addressOut_DEC->setMinimumSize(QSize(0, 30));
        addressOut_DEC->setMaximumSize(QSize(16777215, 30));
        ...
        importAddressButton_DEC->setMinimumSize(QSize(120, 30));
        importAddressButton_DEC->setMaximumSize(QSize(120, 30));
    ...
    void retranslateUi(QDialog *Bip38ToolDialog)
    {
        ...
        infoLabel_ENC->setText(QApplication::translate("Bip38ToolDialog", "Enter a QMC Address that you would like to encrypt using BIP 38. Enter a passphrase in the middle box. Press encrypt to compute the encrypted private key.", Q_NULLPTR));
        label_5->setText(QApplication::translate("Bip38ToolDialog", "Address:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        addressIn_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "The QMC address to sign the message with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptKeyButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Sign the message to prove you own this QMC address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptedKeyIn_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "The QMC address the message was signed with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        decryptKeyButton_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "Verify the message to ensure it was signed with the specified QMC address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
