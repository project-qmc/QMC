...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setMinimumSize(QSize(160, 30));
        openDebugLogfileButton->setMaximumSize(QSize(160, 30));
        ...
        clearButton->setMinimumSize(QSize(30, 30));
        clearButton->setMaximumSize(QSize(30, 30));
        QIcon icon;
        ...
        btnClearTrafficGraph->setMinimumSize(QSize(100, 30));
        btnClearTrafficGraph->setMaximumSize(QSize(100, 30));
        ...
        btn_resync->setMinimumSize(QSize(160, 30));
        ...
        btn_salvagewallet->setMinimumSize(QSize(160, 30));
        ...
        btn_rescan->setMinimumSize(QSize(160, 30));
        ...
        btn_zapwallettxes1->setMinimumSize(QSize(160, 30));
        ...
        btn_zapwallettxes2->setMinimumSize(QSize(160, 30));
        ...
        btn_upgradewallet->setMinimumSize(QSize(160, 30));
        ...
        btn_reindex->setMinimumSize(QSize(160, 30));
