...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->setWindowTitle(QStringLiteral("ROI and Stats Information"));
        HelpMessageDialog->setStyleSheet(QStringLiteral("QPushButton{width: 80px; height: 25px;}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 479, 68));
