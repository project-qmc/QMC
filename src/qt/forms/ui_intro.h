...
public:
    ...
    void setupUi(QDialog *Intro)
    {
        ...
        Intro->setStyleSheet(QStringLiteral("QPushButton{width: 80px; height: 25px;}"));
        ...
        dataDirectory->setMinimumSize(QSize(0, 30));
        dataDirectory->setMaximumSize(QSize(16777215, 30));
        ...
        ellipsisButton->setMinimumSize(QSize(40, 30));
        ellipsisButton->setMaximumSize(QSize(40, 30));
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to QMC Core.", Q_NULLPTR));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where QMC Core will store its data.", Q_NULLPTR));
        sizeWarningLabel->setText(QApplication::translate("Intro", "QMC Core will download and store a copy of the QMC block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", Q_NULLPTR));
