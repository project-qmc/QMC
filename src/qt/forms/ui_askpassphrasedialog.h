...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        AskPassphraseDialog->setStyleSheet(QStringLiteral("QPushButton{width: 80px; height: 25px;}"));
        ...
        passEdit1->setMinimumSize(QSize(0, 25));
        passEdit1->setMaximumSize(QSize(16777215, 25));
        ...
        passEdit2->setMinimumSize(QSize(0, 25));
        passEdit2->setMaximumSize(QSize(16777215, 25));
        ...
        passEdit3->setMinimumSize(QSize(0, 25));
        passEdit3->setMaximumSize(QSize(16777215, 25));
...
#endif // QT_NO_TOOLTIP
        anonymizationCheckBox->setText(QApplication::translate("AskPassphraseDialog", "For anonymization and staking only", Q_NULLPTR));
    } // retranslateUi
