...
public:
    ...
    void setupUi(QMainWindow *BlockExplorer)
    {
        ...
        back->setMinimumSize(QSize(100, 30));
        back->setMaximumSize(QSize(100, 30));
        QIcon icon;
        ...
        forward->setMinimumSize(QSize(100, 30));
        forward->setMaximumSize(QSize(100, 30));
        QIcon icon1;
        ...
        searchBox->setMinimumSize(QSize(0, 30));
        searchBox->setMaximumSize(QSize(16777215, 30));
        ...
        pushSearch->setMinimumSize(QSize(100, 30));
        pushSearch->setMaximumSize(QSize(100, 30));
