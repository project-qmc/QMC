...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        CoinControlDialog->setStyleSheet(QStringLiteral("QPushButton{width: 80px; height: 25px;}"));
        ...
        pushButtonSelectAll->setMinimumSize(QSize(120, 30));
        pushButtonSelectAll->setMaximumSize(QSize(120, 30));
        ...
        pushButtonToggleLock->setMinimumSize(QSize(120, 30));
        pushButtonToggleLock->setMaximumSize(QSize(120, 30));
        ...
        verticalLayout->addWidget(buttonBox, 0, Qt::AlignRight);
