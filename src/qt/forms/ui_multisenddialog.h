...
public:
    ...
    void setupUi(QDialog *MultiSendDialog)
    {
        ...
        multiSendPercentEdit->setGeometry(QRect(170, 130, 201, 30));
        multiSendPercentEdit->setMinimumSize(QSize(0, 30));
        multiSendPercentEdit->setMaximumSize(QSize(16777215, 30));
        multiSendAddressEdit = new QLineEdit(MultiSendDialog);
        multiSendAddressEdit->setObjectName(QStringLiteral("multiSendAddressEdit"));
        multiSendAddressEdit->setGeometry(QRect(170, 160, 401, 30));
        multiSendAddressEdit->setMinimumSize(QSize(0, 30));
        multiSendAddressEdit->setMaximumSize(QSize(16777215, 30));
        ...
        addButton->setGeometry(QRect(20, 230, 130, 30));
        ...
        disableButton->setGeometry(QRect(150, 260, 130, 30));
        disableButton->setMinimumSize(QSize(130, 30));
        disableButton->setMaximumSize(QSize(130, 30));
        addressBookButton = new QPushButton(MultiSendDialog);
        addressBookButton->setObjectName(QStringLiteral("addressBookButton"));
        addressBookButton->setGeometry(QRect(570, 160, 30, 30));
        ...
        deleteButton->setGeometry(QRect(150, 230, 130, 30));
        deleteButton->setMinimumSize(QSize(130, 30));
        deleteButton->setMaximumSize(QSize(130, 30));
        activateButton = new QPushButton(MultiSendDialog);
        activateButton->setObjectName(QStringLiteral("activateButton"));
        activateButton->setGeometry(QRect(20, 260, 130, 30));
        activateButton->setMinimumSize(QSize(130, 30));
        activateButton->setMaximumSize(QSize(130, 30));
        viewButton = new QPushButton(MultiSendDialog);
        viewButton->setObjectName(QStringLiteral("viewButton"));
        viewButton->setGeometry(QRect(20, 200, 260, 30));
        viewButton->setMinimumSize(QSize(260, 30));
        viewButton->setMaximumSize(QSize(260, 30));
        horizontalLayoutWidget = new QWidget(MultiSendDialog);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(30, 100, 363, 25));
