...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->setStyleSheet(QLatin1String("QStackedWidget{border: none;}\n"
...
""));
        ...
        addAsLabel->setMaximumSize(QSize(16777215, 30));
        ...
        payAmount->setMaximumSize(QSize(16777215, 30));
        ...
        deleteButton_is->setMinimumSize(QSize(30, 30));
        deleteButton_is->setMaximumSize(QSize(30, 30));
        ...
        payAmount_is->setMinimumSize(QSize(0, 30));
        payAmount_is->setMaximumSize(QSize(16777215, 30));
        ...
        deleteButton_s->setMinimumSize(QSize(30, 30));
        deleteButton_s->setMaximumSize(QSize(30, 30));
        ...
        payAmount_s->setMinimumSize(QSize(0, 30));
        payAmount_s->setMaximumSize(QSize(16777215, 30));
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The QMC address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the QMC: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the QMC network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
