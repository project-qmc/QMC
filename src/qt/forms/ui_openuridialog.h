...
public:
    ...
    void setupUi(QDialog *OpenURIDialog)
    {
        ...
        OpenURIDialog->resize(564, 122);
        OpenURIDialog->setStyleSheet(QStringLiteral("QPushButton{width: 80px; height: 25px;}"));
        ...
        uriEdit->setMaximumSize(QSize(16777215, 30));
        ...
        selectFileButton->setMinimumSize(QSize(100, 30));
        selectFileButton->setMaximumSize(QSize(100, 30));
