...
public:
    ...
    void setupUi(QDialog *ReceiveRequestDialog)
    {
        ...
        ReceiveRequestDialog->setStyleSheet(QStringLiteral("QPushButton{width: 80px; height: 25px;}"));
        ...
        btnCopyURI->setMinimumSize(QSize(110, 30));
        btnCopyURI->setMaximumSize(QSize(110, 30));
        ...
        btnCopyAddress->setMinimumSize(QSize(110, 30));
        btnCopyAddress->setMaximumSize(QSize(110, 30));
        ...
        btnSaveAs->setMinimumSize(QSize(110, 30));
        btnSaveAs->setMaximumSize(QSize(110, 30));
