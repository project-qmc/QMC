...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        newAddress->setMinimumSize(QSize(100, 30));
        newAddress->setMaximumSize(QSize(100, 30));
        QIcon icon;
        ...
        copyAddress->setMinimumSize(QSize(100, 30));
        copyAddress->setMaximumSize(QSize(100, 30));
        QIcon icon1;
        ...
        deleteAddress->setMinimumSize(QSize(100, 30));
        deleteAddress->setMaximumSize(QSize(100, 30));
        QIcon icon2;
        ...
        exportButton->setMaximumSize(QSize(100, 30));
        QIcon icon3;
        ...
        closeButton->setMaximumSize(QSize(100, 30));
