...
In order to support loading of multiple wallets in qmc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is qmc.cpp.
...
Changes to qmc.cpp
----------------------
qmc.cpp is the entry point into qmc-qt, and as such, will require some minor modifications to provide hooks for
