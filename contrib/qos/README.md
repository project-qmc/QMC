...
This means one can have an always-on qmcd instance running, and another local qmcd/qmc-qt instance which connects to this node and receives blocks from it.
