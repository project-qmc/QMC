...
RESOURCES += src/qt/qmc.qrc src/qt/qmc_locale.qrc

TRANSLATIONS += src/qt/locale/qmc_bg.ts \
                src/qt/locale/qmc_de.ts \
                src/qt/locale/qmc_en.ts \
                src/qt/locale/qmc_es.ts \
                src/qt/locale/qmc_fi.ts \
                src/qt/locale/qmc_fr.ts \
                src/qt/locale/qmc_it.ts \
                src/qt/locale/qmc_ja.ts \
                src/qt/locale/qmc_pl.ts \
                src/qt/locale/qmc_pt.ts \
                src/qt/locale/qmc_ru.ts \
                src/qt/locale/qmc_sk.ts \
                src/qt/locale/qmc_sv.ts \
                src/qt/locale/qmc_vi.ts \
                src/qt/locale/qmc_zh_CN.ts \
                src/qt/locale/qmc_zh_TW.ts
