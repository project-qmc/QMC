Contributing to QMCoin Core
============================

The QMCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the QMCoin Core project, and is not to be
confused with overall QMCoin Network Protocol consensus changes.

Whether a pull request is merged into QMCoin Core rests with the project merge
...
Patches that change QMCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the QMCoin consensus, it must have been
...
The project leader is the release manager for each QMCoin Core release.
