...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='qmc2.conf'
CONFIGFOLDER='/root/.qmc2'
COIN_DAEMON='/usr/local/bin/qmcd'
COIN_CLI='/usr/local/bin/qmc-cli'
COIN_REPO='https://github.com/project-qmc/QMC/releases/download/v1.0.1/linux_cli.tar.xz'
COIN_NAME='QualityMagnetCoin'
COIN_PORT=28443
RPC_PORT=55777
...
function compile_node() {
  ...
  xz --decompress $COIN_ZIP >/dev/null 2>&1
  tar xvf linux_cli.tar
  compile_error
  cp qmc* /usr/local/bin
  chmod a+x /usr/local/bin/qmc*
  cd - >/dev/null 2>&1
